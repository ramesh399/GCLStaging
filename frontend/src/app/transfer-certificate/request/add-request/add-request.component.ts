...
export class AddRequestComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.productForm = this.fb.group({
        ...
        gross_weight:['',[Validators.required, Validators.maxLength(10),Validators.pattern('^[0-9]+(\.[0-9]{1,2})?$'),Validators.min(1)]],
        net_weight:['',[Validators.required, Validators.maxLength(10),Validators.pattern('^[0-9]+(\.[0-9]{1,2})?$'),Validators.min(1)]],
        certified_weight:['',[Validators.required, Validators.maxLength(10),Validators.pattern('^[0-9]+(\.[0-9]{1,2})?$'),Validators.min(1)]], 		
