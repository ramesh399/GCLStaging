...
export class ApplicationListService {
  ...
  addApplication(applicationData){
    ...
    //let applicationDatas = Object.assign({}, applicationData);
    return this.http.post<any>(`${environment.apiUrl}/application/create`, applicationData);
    //, JSON.stringify(data)
  }

  getApplication():Observable<any>{
    
    return this.http.get<any>(`${environment.apiUrl}/application/index`,this.httpOptions);
