...
import { BrandGroupListService } from '@app/services/master/brand-group/brand-group-list.service';

@Component({
  selector: 'app-list-brand-group',
  templateUrl: './list-brand-group.component.html',
  styleUrls: ['./list-brand-group.component.scss']
})
export class ListBrandGroupComponent implements OnInit {
  ...
  constructor(public service: BrandGroupListService,private modalService: NgbModal,private fb:FormBuilder,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService,private countryservice: CountryService){
    this.brands$ = service.franchises$;
