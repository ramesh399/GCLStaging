				...
				if(count($TcRawMaterialUsedWeight)>0){
					foreach($TcRawMaterialUsedWeight as $UsedWeightObj){
						...
						$materialused[] = [
							...
							'tc_number' => $UsedWeightObj->rawmaterial->tc_number==''?$UsedWeightObj->rawmaterial->invoice_attachment:$UsedWeightObj->rawmaterial->tc_number,
							'tc_attachment' => $UsedWeightObj->rawmaterial->tc_attachment==''?$UsedWeightObj->rawmaterial->invoice_attachment:$UsedWeightObj->rawmaterial->tc_attachment,
